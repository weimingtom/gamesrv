...
ccard115001 = class("ccard115001",super,{
    sid = 115001,
    race = 1,
    name = "变形术",
    type = 101,
    ...
    desc = "将一个仆从变成一个1/1的羊",
    effect = {
        onuse = {addfootman={sid=116002,num=1}},
        ondie = nil,
        onhurt = nil,
        onrecoverhp = nil,
        onbeginround = nil,
...
function ccard115001:init(conf)
    super.init(self,conf)
--<<card 导表结束>>

end --导表生成

function ccard115001:load(data)
