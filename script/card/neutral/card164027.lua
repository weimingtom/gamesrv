...
function ccard164027:init(conf)
...
function ccard164027:ondie()
	local owner = self:getowner()
	local sid = ccard164027.effect.ondie.addfootman.sid
	local num = ccard164027.effect.ondie.addfootman.num
